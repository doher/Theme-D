...
function squareRoots(a, b, c) {
    ...
    if (a == 0) {
        return [-c / b]; // линейноее уравнение
    }
...
function squareRootsTests() {
    ...
    console.log('тест 1, 1, 1 -> нет вещественных корней');
    ...
    console.log('тест 0, 5, -5 -> линейное уравнение, один корень 1');
